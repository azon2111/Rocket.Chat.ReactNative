export default {
	...
	Invisible: 'Невидимый',
	Invite: 'Приглашение',
	is_a_valid_RocketChat_instance: 'является действительным сервером OliveUC',
	is_not_a_valid_RocketChat_instance: 'не является действительным сервером OliveUC',
	is_typing: 'печатает',
	...
	Not_RC_Server: 'Это не сервер OliveUC.\n{{contact}}',
	Nothing: 'Ничего',
	...
	Offline: 'Офлайн',
	Oops: 'Упс!',
	Onboarding_title: 'Добро пожаловать в OliveUC',
	Online: 'Онлайн',
	...
	you: 'вы',
	You: 'Вы',
	You_need_to_access_at_least_one_RocketChat_server_to_share_something: 'Вам нужно получить доступ как минимум к одному серверу OliveUC, чтобы поделиться чем-то.',
